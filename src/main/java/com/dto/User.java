...
public class User {
	...
	public User(int user_id, String user_name, String mailusedforlogin, String first_name, String last_name,
			String account_type, ArrayList<Contact> contacts, ArrayList<Contact> groupContacts,
			ArrayList<String> othermails) {
