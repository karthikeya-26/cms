...
public enum UserGroups implements Columns {
    ...
    private static final Map<String, UserGroups> LOOKUP_MAP = new HashMap<>();
    ...
    public static UserGroups getCol(String colName) {
        UserGroups userGroup = LOOKUP_MAP.get(colName);
        if (userGroup == null) {
