...
public enum AccessTokens implements Columns {
	ACCESSTOKEN_ID("accesstoken_id", Integer.class), ACCESS_TOKEN("access_token", String.class),
	SCOPES("scopes", String.class), CREATED_AT("created_at", Long.class), REFTOKEN_ID("reftoken_id", Integer.class),
	USER_ID("user_id", Integer.class), CLIENT_ID("client_id", String.class), ALL_COLS("*", null);
