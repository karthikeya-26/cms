...
public enum AuthorizationCodes implements Columns {
	AUTHCODE_ID("authcode_id", Integer.class), AUTHORIZATION_CODE("authorization_code", String.class),
	CLIENT_ID("client_id", String.class), USER_ID("user_id", Integer.class), CREATED_AT("created_at", Long.class),
	SCOPES("scopes", String.class), ACCESS_TYPE("access_type", String.class), ALL_COLS("*", null);
