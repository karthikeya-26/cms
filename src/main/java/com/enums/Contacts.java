...
public enum Contacts implements Columns {
	CONTACT_ID("contact_id", Integer.class), FIRST_NAME("first_name", String.class),
	LAST_NAME("last_name", String.class), USER_ID("user_id", Integer.class), CREATED_AT("created_at", Long.class),
	MODIFIED_AT("modified_at", Long.class), REF_ID("ref_id", String.class),
	REFRESH_TOKEN("refresh_token", String.class), ALL_COLS("*", null);
