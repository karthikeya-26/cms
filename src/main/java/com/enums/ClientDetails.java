...
public enum ClientDetails implements Columns {
	...
	CLIENT_ID("client_id", String.class), USER_ID("user_id", Integer.class), CLIENT_NAME("client_name", String.class),
	CLIENT_TYPE("client_type", String.class), CLIENT_SECRET("client_secret", String.class),
	CREATED_AT("created_at", Long.class), MODIFIED_AT("modified_at", Long.class), SCOPES("scopes", String.class),
	ALL_COLS("*", null);
