...
public enum RefreshTokens implements Columns {
	REFTOKEN_ID("reftoken_id", Integer.class), REFRESH_TOKEN("refresh_token", String.class),
	CLIENT_ID("client_id", String.class), USER_ID("user_id", Integer.class), SCOPES("scopes", String.class),
	CREATED_AT("created_at", Long.class), ALL_COLS("*", null);
