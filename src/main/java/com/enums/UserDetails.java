...
public enum UserDetails implements Columns {
	USER_ID("user_id", Integer.class), USER_NAME("user_name", String.class), FIRST_NAME("first_name", String.class),
	LAST_NAME("last_name", String.class), CONTACT_TYPE("contact_type", String.class),
	CREATED_AT("created_at", Long.class), MODIFIED_AT("modified_at", Long.class),
	PROVIDER_AC_ID("provider_ac_id", String.class), ALL_COLS("*", null);
