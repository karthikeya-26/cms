...
public class RefreshTokensDao {
	...
	public RefreshTokensObj getRefTokenObj(String refreshToken) throws QueryException {
		...
		getToken.table(Table.RefreshTokens)
		.condition(RefreshTokens.REFRESH_TOKEN, Operators.Equals, refreshToken);
	...
	public int addRefreshToken(String refreshToken, String clientId, Integer userId, String scopes) throws QueryException {
		Insert addToken = new Insert();
		addToken.table(Table.RefreshTokens).columns(RefreshTokens.REFRESH_TOKEN,RefreshTokens.CLIENT_ID,RefreshTokens.USER_ID,RefreshTokens.SCOPES)
	...
	public boolean deleteUserRefreshTokens(Integer userId) throws QueryException{
		...
		deleteUserTokens.table(Table.RefreshTokens).condition(RefreshTokens.USER_ID,Operators.Equals,userId.toString());
