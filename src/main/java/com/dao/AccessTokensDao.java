...
public class AccessTokensDao {
	...
	public AccessTokensObj getAccessTokenObject(String accessToken) throws QueryException {
		...
		getaccessTokenObject.table(Table.AccessTokens).condition(AccessTokens.ACCESS_TOKEN, Operators.Equals,
				accessToken);
	...
	// INSERT
	public boolean addAccessToken(String accessToken, String scopes, Integer userId, String clientId,
			Integer refTokenId) throws QueryException {
