...
public class ClientDetailsDao {
	...
	// INSERT
	public boolean addClient(String clientId, Integer userId, String clientName, String clientType, String clientSecret,
			String scopes) throws DaoException {
		Insert i = new Insert();
		i.table(Table.ClientDetails).columns(ClientDetails.CLIENT_ID, ClientDetails.USER_ID, ClientDetails.CLIENT_NAME,
				ClientDetails.CLIENT_TYPE, ClientDetails.CLIENT_SECRET, ClientDetails.SCOPES);
	...
	public boolean updateClient(String clientId, Integer userId, String clientName, String clientType,
			String clientSecret) throws DaoException {
		Update u = new Update();
		u.table(Table.ClientDetails);
		u.columns(ClientDetails.CLIENT_ID, ClientDetails.USER_ID, ClientDetails.CLIENT_NAME, ClientDetails.CLIENT_TYPE,
	...
	public boolean deleteClient(String clientId) throws DaoException {
		...
		deleteClient.table(Table.ClientDetails).condition(ClientDetails.CLIENT_ID, Operators.Equals, clientId)
